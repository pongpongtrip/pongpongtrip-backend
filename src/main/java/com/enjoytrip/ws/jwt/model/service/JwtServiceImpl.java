package com.enjoytrip.ws.jwt.model.service;
...
import com.enjoytrip.ws.exception.UnAuthorizedException;
...
//	SALT는 토큰 유효성 확인 시 사용하기 때문에 외부에 노출되지 않게 주의해야 한다.
	...
	public <T> String createAccessToken(String key, T data) {
		return create(key, data, "access-token", 1000 * 60 * ACCESS_TOKEN_EXPIRE_MINUTES); //1분 
